          ...
          <div className="relative grid overflow-hidden rounded-3xl border border-light-border bg-[#f7f8f8] shadow-xl shadow-black/5 dark:border-dark-border dark:bg-dark-surface dark:shadow-black/20 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="hidden min-h-[680px] flex-col justify-between bg-light-surface p-10 dark:bg-[#282d2d] lg:flex xl:p-14">
              <div>
                ...
                <div className="mt-20 max-w-lg">
                  <div className="inline-flex items-center gap-2 rounded-full border border-light-border bg-light-surface-soft px-3 py-1.5 text-sm font-medium text-light-text-muted dark:border-dark-border dark:bg-dark-surface-soft dark:text-dark-text-muted">
                  ...
                  <h1 className="mt-6 text-4xl font-bold tracking-tight text-light-text dark:text-dark-text xl:text-5xl">
                    Let&apos;s get your
                    <span className="text-brand-teal"> Vibe verified.</span>
                  </h1>

                  <p className="mt-5 max-w-lg text-base leading-7 text-light-text-muted dark:text-dark-text-muted">
                    Verification links are temporary security credentials.
                    If one has expired or can&apos;t be used, you can simply
                    request a fresh one.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-light-text-muted dark:text-dark-text-muted">
                      Verification links are designed to expire and
            ...
            <div className="relative flex min-h-[680px] flex-col justify-center p-6 sm:p-8 lg:p-10 xl:p-14">
              ...
              <div className="mx-auto w-full max-w-md text-center">
                {/* Error icon */}
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-red-50 text-red-500 dark:bg-red-500/10 dark:text-red-400">
                <AlertTriangleIcon className="mt-0.5 h-5 w-5 shrink-0 text-red-500 dark:text-red-400" />
                </div>
                ...
                <div className="mt-7">
                  ...
                  <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-light-text-muted dark:text-dark-text-muted">
                    This verification link may have expired, already
                ...
                <div className="mt-8 rounded-2xl border border-light-border-soft bg-light-surface-soft p-5 text-left dark:border-dark-border-soft dark:bg-dark-surface-soft">
                  <div className="flex items-start gap-3">
                    <AlertTriangleIcon className="mt-0.5 h-5 w-5 shrink-0 text-light-text-muted dark:text-dark-text-muted" />
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-light-text-muted dark:text-dark-text-muted">
                        Request a new verification email and use the
                        latest link sent to your inbox.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-7">
                  <Link
                    href="/verify-email"
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-teal px-4 py-3.5 text-sm font-semibold text-white shadow-sm shadow-brand-teal/20 transition hover:bg-brand-teal-dark focus:outline-none focus:ring-4 focus:ring-brand-teal/20 active:scale-[0.99]"
                  >
                ...
                <div className="mt-6 flex items-start gap-2.5 text-left">
                  ...
                  <p className="text-xs leading-5 text-light-text-soft dark:text-dark-text-soft">
                    For your security, only the most recent valid
                    verification link should be used.
                  </p>
                </div>
              </div>
            </div>
