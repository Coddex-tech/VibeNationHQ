...
export function NewsIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export function WhatsappIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984 0 1.758.459 3.474 1.33 4.982L2 22l5.176-1.332c1.458.796 3.102 1.216 4.835 1.216h.005c5.507 0 9.99-4.48 9.99-9.986 0-2.667-1.037-5.176-2.922-7.061C17.197 3.037 14.68 2 12.012 2zm5.835 14.288c-.245.692-1.228 1.32-1.705 1.382-.477.062-1.077.288-3.568-.72-2.983-1.208-4.9-4.225-5.05-4.422-.15-.198-1.208-1.603-1.208-3.056 0-1.453.765-2.167 1.038-2.463.272-.296.596-.37.795-.37.198 0 .396.002.57.01.185.008.435-.07.68.518.245.588.832 2.03.905 2.178.073.148.122.322.025.518-.098.198-.148.322-.296.495-.148.173-.312.387-.446.52-.148.148-.302.31-.13.606.173.296.768 1.267 1.648 2.052 1.134 1.01 2.09 1.323 2.386 1.47.296.148.47.123.643-.074.173-.198.742-.865.94-1.162.198-.297.396-.248.668-.148.272.098 1.73.816 2.027.965.297.148.495.222.569.346.074.123.074.716-.171 1.408z" />
    </svg>
  );
}
...
export function ScaleIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 6l9-4 9 4v2H3V6zm2 6v6a2 2 0 002 2h10a2 2 0 002-2v-6M5 12l7 3 7-3" />
    </svg>
  );
}
...
export function CopyrightIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.3 4.3l-7.1 12.3A2 2 0 005 20h14a2 2 0 001.8-3.4L13.7 4.3a2 2 0 00-3.4 0z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3 10.5L12 3l9 7.5M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9M9 20v-6h6v6"
      />
    </svg>
  );
}
